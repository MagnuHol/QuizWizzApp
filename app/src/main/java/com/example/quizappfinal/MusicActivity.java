...
public class MusicActivity extends AppCompatActivity implements View.OnClickListener {
    ...
    public ArrayList<Question> getQuestions (){
        ...
        Question q1 = new Question(
                1,
               "What song is this?",
                MediaPlayer.create(getApplicationContext(),R.raw.hurrylove),
                "Hurry love",
                "Gone in the wind",
                "Showbiz",
                "The Void",
        ...
        Question q2 = new Question(
                1,
                "What song is this?",
                MediaPlayer.create(getApplicationContext(), R.raw.intheair),
                "One more night",
                "Sunburn",
                "In the air tonight",
                "Piano Thing",
        ...
        Question q3 = new Question(
                1,
                "What song is this?",
                MediaPlayer.create(getApplicationContext(), R.raw.easylover),
                "Unintended",
        ...
        Question q4 = new Question(
                1,
                "What song is this?",
                MediaPlayer.create(getApplicationContext(), R.raw.paradise),
                "Stranger like me",
        ...
        Question q5 = new Question(
                1,
                "What song is this?",
                MediaPlayer.create(getApplicationContext(), R.raw.strangers),
                "Tell me more",
                "two hearts",
                "Songs sang",
                "Stranger like me",
